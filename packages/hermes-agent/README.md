...
多实例 Hermes 的端口与注册表仍见仓库根 [docs/open-agent-teams/hermes-instances.template.yaml](../../docs/open-agent-teams/hermes-instances.template.yaml)；本包不负责替代 Hermes 自带配置目录（通常为 `~/.hermes`）。
