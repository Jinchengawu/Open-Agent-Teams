...
export type A2ATaskState = 'submitted' | 'working' | 'completed' | 'failed' | 'canceled' | 'rejected' | 'auth_required' | 'unknown';
export type A2APart = {
    kind: 'text';
    text: string;
...
export declare function isA2ATask(value: A2ASendMessageResult): value is A2ATask;
export declare function isTerminalA2ATaskState(state: A2ATaskState): boolean;
