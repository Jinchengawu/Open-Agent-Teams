...
export class TeamOrchestrator {
    ...
    constructor(config) {
        ...
        const teamAgents = config.agents.map((a) => ({
            name: a.id,
 ...
 */
export function createTeamOrchestrator(agents, model) {
 ...
 */
export function createDevTeamOrchestrator() {
