...
export class Surface {
    ...
    constructor(def, orchestrator, sessionId) {
        this.definition = def;
        this.orchestrator = orchestrator;
        this.sessionId = sessionId || `surface-${def.id}`;
    }
    isAgentFailureOutput(output) {
 ...
 * 面工厂
 */
export function createSurface(definition, orchestrator, sessionId) {
