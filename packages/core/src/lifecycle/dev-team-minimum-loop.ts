import { OPEN_TEAM_MINIMUM_LOOP_PIPELINE } from '../team-profile/open-framework-profile.js';
 ...
 */
export const DEV_TEAM_MINIMUM_LOOP_PIPELINE = OPEN_TEAM_MINIMUM_LOOP_PIPELINE;
