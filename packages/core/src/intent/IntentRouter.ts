...
function toProviderSafeMessages(messages: ProviderMessage[]): Array<{ role: 'user' | 'assistant'; content: string }> {
...
输出 JSON 格式的路由决策。`;
  ...
  private resolveDefaultAgentId(candidate?: string): string {
