...
> 事实边界：本仓库以**方案 A（纯集成编排）**为主——交付规格、路由规则、实例模板、移交清单与 Node 工作区纳管；**不**声称已自研 Open Multi-Agent/Hermes 运行时或虚构 API。

---

## 一、核心痛点（可压缩进问卷）

1. **私有化「本地智能 OS」缺标准件**：需要 `@open-multi-agent/core` 作统一调度内核、多实例 Hermes 作垂类心智与长期记忆，但缺少可落地的**数据域划分、路由原则与集成顺序**，易停留在 PDF/口号层。  
