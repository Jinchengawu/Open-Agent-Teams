...
本目录存放 **Open Multi-Agent + 多实例 Hermes** 私有化集成的**文档与占位模板**，与下列文件一起阅读：

| 顺序 | 文档 | 说明 |
| --- | --- | --- |
| 1 | [../specs/2026-04-26-open-agent-teams-design.md](../specs/2026-04-26-open-agent-teams-design.md) | 架构、数据域、路由原则、待补材料 |
